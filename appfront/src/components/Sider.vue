<template>
  <a-layout id="components-layout-demo-fixed-sider">
    ...
    collapsible
    v-model="collapsed">
      <div :style="{'position': 'fixed', 'top': '0px', 'width': navWidth}">
        ...
        <h2 v-if="!collapsed" style="color:white;position:absolute;left:70px;top:23px">测试平台</h2>
      </div>
      <a-menu theme="dark" mode="inline" :defaultSelectedKeys="['testcaseML']" :defaultOpenKeys="['testcase']" :style="{'position': 'fixed', 'top': '80px', 'width': navWidth}">
